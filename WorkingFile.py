...
#Funciton to make the email contents
def makeEmail(ty):
    today = date.today()
...
tm = 1 # --Interval in minutes between reads              ######## TESTING CHANGE BACK TO 3 !!!!!!!!!
...
tempLB_F = 81 # Lower bound of temperature in Farheneit       ########### TESTING CHANGEW BACK TO 62 !!!!!!!!
